...
import { createPaciente } from 'src/services/users/createPaciente';
...
const AgregarPaciente = props => {
  ...
  const processClick = () => {
    if (Object.values(data).length < 2) {
      return printError(
        'Debe llenar toda la información para poder crear el cazatalentos: nombre e identificación'
      );
    }
        ...
        <CCard className="mb-4">
          <CCardBody>
            <CForm className="row m-0">
              ...
              <CCol xs={12} className="mb-3">
                <CFormLabel htmlFor="exampleFormControlInput1">Número de identificación</CFormLabel>
                <CFormInput
